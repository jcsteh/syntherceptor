...
Section "Install"
	...
	WriteRegStr HKLM "SOFTWARE\Microsoft\Speech\Voices\Tokens\syntherceptor\Attributes" "Version" "${VERSION}"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Syntherceptor" "DisplayVersion" "${VERSION}"
